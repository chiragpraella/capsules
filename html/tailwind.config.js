...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      // Fluid widths
      width: {
        '200': 'calc(100vw / 1920 * 200)',
        '300': 'calc(100vw / 1920 * 300)',
        '400': 'calc(100vw / 1920 * 400)',
        '500': 'calc(100vw / 1920 * 500)',
        '600': 'calc(100vw / 1920 * 600)',
        '800': 'calc(100vw / 1920 * 800)',
        '1000': 'calc(100vw / 1920 * 1000)',
        '1200': 'calc(100vw / 1920 * 1200)',
      },
      // Fluid heights
      height: {
        '200': 'calc(100vw / 1920 * 200)',
      ...
      gap: {
        '5': 'calc(100vw / 1920 * 5)',
        '10': 'calc(100vw / 1920 * 10)',
        '15': 'calc(100vw / 1920 * 15)',
        '20': 'calc(100vw / 1920 * 20)',
        '30': 'calc(100vw / 1920 * 30)',
        '40': 'calc(100vw / 1920 * 40)',
        '50': 'calc(100vw / 1920 * 50)',
      },
      // Fluid border radius
      borderRadius: {
        'sm': 'calc(100vw / 1920 * 4)',
        'md': 'calc(100vw / 1920 * 8)',
        'lg': 'calc(100vw / 1920 * 12)',
        'xl': 'calc(100vw / 1920 * 16)',
        '2xl': 'calc(100vw / 1920 * 24)',
      },
      // Additional fluid letter spacing
      letterSpacing: {
        'tight': 'calc(100vw / 1920 * -0.5)',
        'normal': '0',
        'wide': 'calc(100vw / 1920 * 0.5)',
        'wider': 'calc(100vw / 1920 * 1)',
        'widest': 'calc(100vw / 1920 * 2)',
      },
      // Additional fluid line-heights
      lineHeight: {
        'tight': 'calc(100vw / 1920 * 20)',
        'normal': 'calc(100vw / 1920 * 24)',
        'relaxed': 'calc(100vw / 1920 * 28)',
        'loose': 'calc(100vw / 1920 * 32)',
      },
    },
  },
  plugins: [
      ...
      matchUtilities(
        {
          ...
          '@tracking': (value) => ({
            letterSpacing: `calc(${value} / 1920 * 100vw)`,
          }),
          '@leading': (value) => ({
            lineHeight: `calc(${value} / 1920 * 100vw)`,
          }),
        },
        { values: {} }
      );
